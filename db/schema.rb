...
ActiveRecord::Schema.define(version: 20170112132441) do
  ...
  create_table "chat_group_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["group_id"], name: "index_chat_group_users_on_group_id", using: :btree
  ...
  add_foreign_key "chat_group_users", "groups"
